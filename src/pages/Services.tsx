  ...
  const services: Service[] = [
    {
      ...
      includes: [
        ...
        'Practical frameworks for integrating AI into day-to-day work',
    ...
    },
    {
      ...
      includes: [
        ...
        'Ongoing guidance to scale learning and capability',
      ],
      cta: 'Start Planning',
    },
    {
      ...
      includes: [
        'Discovery session to identify mindset gaps and resistance points',
        'Custom change management framework for AI transformation',
        'Stakeholder mapping and engagement strategy',
        'Leadership communication templates and talking points',
        'Follow-up support to ensure AI becomes a capability, not a disruption',
      ],
      cta: 'Build AI Readiness',
    },
    {
      ...
      includes: [
        'Organization-wide AI fluency assessment and baseline',
        'Scalable learning programs tailored to different roles and departments',
        'Development of shared AI language, skills, and confidence',
        'Best practices, templates, and decision frameworks',
        'Implementation support to ensure AI capability becomes a cultural strength',
      ],
      cta: 'Scale AI Fluency',
    },
    {
      ...
      includes: [
        ...
        'Practical frameworks for thriving in an Analog + AI world',
