  ...
  return (
    <div className="bg-softWhite">
      ...
      <section aria-labelledby="speaking-cta-heading" className="bg-navy text-trueWhite py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 id="speaking-cta-heading" className="text-4xl md:text-5xl font-semibold leading-tight text-softWhite mb-6">
      ...
      <section aria-labelledby="final-cta-heading" className="bg-navy text-trueWhite py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 id="final-cta-heading" className="text-4xl md:text-5xl font-semibold leading-tight text-softWhite mb-6">
